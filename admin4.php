...
$avail=mysqli_query($connect_mysql, $accounts) or die("Query Failed : ".mysqli_error());
            ...
            <div id="page-inner">
                  ...
                  <div class="fluid-container" style="padding: 30px; margin-top: 100px; ">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="active" ><a href="admin4.php" ><h4 id="textcolor">Rooms</h4></a></li>
                    </ul>
                    </center>
                </div>
                            ...
                            <tbody>
                              <?php while($rows=mysqli_fetch_array($room)) { ?>
                                    <tr> 
                                        ...
                                        <td>PHP <?php echo $rows['room_price'] ?></td>
